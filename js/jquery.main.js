...
// FAQ
	$('.c_faq-item__head span').on('click', function(){
		$(this).parents('.c_faq-item').toggleClass('active').siblings().removeClass('active');
	});


// about tabs
  $('ul.c_about-tabs__caption').each(function() {
    $(this).find('li').each(function(i) {
      $(this).click(function(){
        $(this).addClass('active').siblings().removeClass('active')
          .closest('div.c_about-tabs').find('div.c_about-tabs__content').removeClass('active').eq(i).addClass('active');
      });
    });
  });
